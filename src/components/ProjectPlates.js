                    ...
                    <div className="projectIntroduction">
                        ...
                        <div className="projectIntroduction--text">
                            <div className="projectLinkedTitle">
                                <a href="http://izgubljene-tablice.com/" target="_blank" rel="noreferrer"><h1 className='projectFrontend--text--title'>Izgubljene-tablice.rs</h1></a>
                                <a href="http://izgubljene-tablice.com/" target="_blank" rel="noreferrer"> <GoLinkExternal /></a>
                            </div>
                            <p>The idea for this project was to make a
                            service where you can report lost or found
                            numberplates. When someone finds your
                            numberplate, you get an e-mail notification
                            and a GPS pin of the location.</p>
                            <p className="projectIntroduction--text--space">The design here needed to be very light, with no animations, because when you are
                            looking for something you lost, you are in
                            panic mode, and animations can be
                            annoying in that situation.</p>
